...
struct Storyboard {
    static let NewsList = StoryboardObject<NewsListViewController>("newsList", UIStoryboard.main)
    static let NewsDetail = StoryboardObject<NewsDetailViewController>("newsDetail", UIStoryboard.main)
}
